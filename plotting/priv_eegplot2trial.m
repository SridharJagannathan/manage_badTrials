% priv_eegplot2trial() - convert EEGPLOT rejections into trial and electrode
...
%
% Usage:
%   >> [trialrej elecrej] = priv_eegplot2trial( eegplotrej, frames, ...
...
function [tmpsig, tmprejelec] = priv_eegplot2trial( TMPREJINIT, pnts, sweeps, color, colorout )
...
if ~isempty(TMPREJ)
    ...
    [~,Idx]=unique(tmp);
	tmprejelec(:,I) = TMPREJ(Idx,6:nbchan+5)';
end;
